...
const ProfilPraticien1 = ({navigation}) => (
  <ProfilPraticien navigation={navigation} />
);
const ContenuScreenNotifications1 = ({navigation}) => (
  <ContenuScreenNotifications navigation={navigation} />
);
const ContenuScreenMesDocteurs1 = ({navigation}) => (
  <ContenuScreenMesDocteurs navigation={navigation} />
);
const ContenuScreenMessages1 = ({navigation}) => (
  <ContenuScreenMessages navigation={navigation} />
);
const ContenuScreenCalender1 = ({navigation}) => (
  <ContenuScreenCalender navigation={navigation} />
);
const ContenuScreenHome1 = ({navigation}) => (
  <ContenuScreenHome navigation={navigation} />
);
const Recherche1 = ({navigation}) => <Recherche navigation={navigation} />;
const RdvFormulaire1 = ({navigation}) => (
  <RdvFormulaire navigation={navigation} />
);
const Calendresultat1 = ({navigation}) => (
  <Calendresultat navigation={navigation} />
);
